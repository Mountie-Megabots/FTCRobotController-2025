...
@Autonomous(name = "FarScorePrePlusPPG", group = "Blue")
public class FarScorePrePlusPPG extends OpMode {
    Follower follower;
    ...
    public void init() {
        ...
        path1.setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(110));
